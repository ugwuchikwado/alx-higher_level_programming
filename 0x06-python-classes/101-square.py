...
class Square:
    def __init__(self, size=0, position=(0, 0)):
        ...
        if len(position) == 2:
            if type(position[0]) is not int\
               or type(position[1]) is not int or type(position) is not tuple:
    ...
    def position(self, value):
        if len(value) == 2:
            if value[0] < 0 or value[1] < 0 or type(value[0]) is not int or\
               type(value[1]) is not int or type(value) is not tuple:
                raise TypeError("position must be a tuple of 2 positive integers")
        else:
            raise TypeError("position must be a tuple of 2 positive integers")
